...
MyPage = Class.extend({
	...
	make: function(){
		...
		let status_chart = function(){
			...
			frappe.call({
				method: "law_sys.lawapp.page.overview.overview.status_chart_2", //dotted path to server method
				callback: function(r) {
					let status = []
					let values = []
					let dataset = []
		...
		let total_clients = function(){
			frappe.call({
				method: "law_sys.lawapp.page.overview.overview.total_clients", //dotted path to server method
				callback: function(r) {
		...
		let satisfied_clients = function(){
			frappe.call({
				method: "law_sys.lawapp.page.overview.overview.satisfied_clients", //dotted path to server method
				callback: function(r) {
		...
		let successfull_cases = function(){
			frappe.call({
				method: "law_sys.lawapp.page.overview.overview.successfull_cases", //dotted path to server method
				callback: function(r) {
		...
		let total_requests = function(){
			frappe.call({
				method: "law_sys.lawapp.page.overview.overview.get_total_requests", //dotted path to server method
				callback: function(r) {
		...
		let new_clients = function(){
			frappe.call({
				method: "law_sys.lawapp.page.overview.overview.new_clients", //dotted path to server method
				callback: function(r) {
